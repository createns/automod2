...
module.exports = {
        ...
        try {
            ...
            if(autoRole) {
                if (autoRole.roleId === targetRoleId) {
                    interaction.editReply("Autorole has already been configured for that role. To disable, run '/autorole-disable' .");
                    return;
                }
    ...
    autoRole.roleId = targetRoleId;            
            ...
            console.log(`There was an error(autoroleconig.js): ${error}.`);
        }
    },
